...
public class PatCompare1 {
    // illustrate how to use compareTo and equals and also shows
    // the different between the two methods

    public static void main(String[] args) {
        Path path1 = Paths.get("Test");
        Path path2 = Paths.get("/home/thach/Desktop/Personal-Git/Java-Certificate-OCP/Test");
