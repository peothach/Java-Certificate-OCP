...
public class Tokenize {
    // read the input file and covert it into "tokens" of words;
    // convert the words to same case (lower case), remove duplicates, and print the words cl
    public static void main(String[] args) {
        ...
        try (Scanner tokenizingScanner = new Scanner(new FileReader(fileName))) {
            ...
            // character, and white-spaces will be returned
            ...
            System.err.println("Cannot read the input file - pass valid file name");
        }
    }
}
